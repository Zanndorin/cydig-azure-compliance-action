...
export class DedicatedHostsImpl {
    ...
    listByHostGroupPagingAll(resourceGroupName, hostGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByHostGroupPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByHostGroupPagingPage(resourceGroupName, hostGroupName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listAvailableSizesPagingAll(resourceGroupName, hostGroupName, hostName, options) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, hostGroupName, hostName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
