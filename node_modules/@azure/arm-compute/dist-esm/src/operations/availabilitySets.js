...
export class AvailabilitySetsImpl {
    ...
    listAvailableSizesPagingAll(resourceGroupName, availabilitySetName, options) {
        return __asyncGenerator(this, arguments, function* listAvailableSizesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listAvailableSizesPagingPage(resourceGroupName, availabilitySetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
