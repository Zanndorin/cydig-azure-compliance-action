 ...
 */
function virtualMachineScaleSetsReapplyMaximumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] ||
            "b4f1213b-cacc-4816-8bfb-f30f90643de8";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] ||
            "VirtualMachineScaleSetReapplyTestRG";
        const vmScaleSetName = "VMSSReapply-Test-ScaleSet";
        const credential = new DefaultAzureCredential();
        const client = new ComputeManagementClient(credential, subscriptionId);
        const result = yield client.virtualMachineScaleSets.beginReapplyAndWait(resourceGroupName, vmScaleSetName);
        console.log(result);
    });
}
/**
 ...
 */
function virtualMachineScaleSetsReapplyMinimumSetGen() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMPUTE_SUBSCRIPTION_ID"] ||
            "b4f1213b-cacc-4816-8bfb-f30f90643de8";
        const resourceGroupName = process.env["COMPUTE_RESOURCE_GROUP"] ||
...
//# sourceMappingURL=virtualMachineScaleSetsReapplySample.js.map