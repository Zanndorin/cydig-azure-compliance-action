...
describe("Compute test", () => {
    ...
    it("availabilitySets list test", function () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(client.availabilitySets.list(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const item = _c;
    ...
    it("virtualMachines list test", function () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const resArray = new Array();
            try {
                for (var _d = true, _e = __asyncValues(client.virtualMachines.list(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const item = _c;
    ...
    it("virtualMachines update test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res1 = yield client.virtualMachines.get(resourceGroupName, virtual_machine_name);
    ...
    it("virtualMachines delete test", function () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            assert.equal(resArray.length, 0);
            yield client.disks.beginDeleteAndWait(resourceGroupName, "myVMosdisk");
